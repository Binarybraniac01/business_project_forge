      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-center md:text-left">
            <span className="text-2xl font-bold text-gradient">{"<MakeMyProject />"}</span>
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href="mailto:makemyproject@gmail.com"
              className="p-3 glass-card rounded-xl text-muted-foreground hover:text-primary hover:glow-primary transition-all duration-300"
            >
              <Mail size={20} />
            </a>
        ...
        <div className="mt-8 pt-8 border-t border-border text-center text-sm text-muted-foreground">
          <p>© {new Date().getFullYear()} MakeMyProject. All rights reserved.</p>
